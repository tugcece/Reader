package com.patika.readerpublisherservice.dto.response;

import com.patika.readerpublisherservice.constants.ReaderConstants;
...
public class GenericResponse<T> {
    ...
    public static <T> GenericResponse<T> success(T data) {
        return GenericResponse.<T>builder()
                .message(ReaderConstants.SUCCESS)
                .date(LocalDateTime.now())
